...
document.writeln('							<li class="nav-item"><a class="nav-link" href=javascript:left_menu("u_add");>회원추가<a></li>');
...
function left_menu(result){
	...
	}else if(result == 'u_add'){
		// 회원 추가
		location.href="./u_registration.html?j_pk_id="+pk_id;
	}
}
